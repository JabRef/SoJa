...
public class NewUserWizard extends JDialog {
    ...
    public NewUserWizard(SidePanel main) {
        ...
        EditFriendsPanel friendsPanel = new EditFriendsPanel(main);
        tab.add("1. Invite/Add Friends", friendsPanel);
        tab.add("2. Friends List", new JLabel("<html>" +
                ...
                "<br>Grouping of friends is not allowed yet." +
                "</html>"));
        tab.add("3. Sharing Items", new JLabel("<html>To share items, choose the items on the main list and click the 'Set Share Settings'<br>" +
                "Choose friends your friends list and either allow or remove share to selected friends."));
        tab.add("4. Sending Items", new JLabel("<html>You can send items to friends through 2 ways. <br>" +
       ...
       tab.add("5. Search Items", new JLabel("<html>The Search box is available and will search for shared items in your network.<br>" +
       ...
       tab.add("6. Chat/View Profile", new JLabel("<html>Double clicking your friend on your friend list will bring up the chat window.<br>" +
               "You may then chat with them if they are online.</html>"));
       tab.add("7. Subscribing to Items", new JLabel("<html>You can subscribe to items shared to you and get updates when they are changed<br>" +
               "The time shown is the time you found changes to the items. It is not the time the items was changed.</html>"));
       tab.add("8. Tag Clouds", new JLabel("<html>The tag clouds are occassionally updated to show the most popular tags in your network.<br>" +
